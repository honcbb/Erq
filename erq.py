...
\___|_|    |_  |
 ...
 ----------------------------------------------------------------------
           ...
           Copyright ERQ Corporation 2016, 2030.
 ----------------------------------------------------------------------
"""

USAGE = """
If there is anyone who wants to join the hash value, if you know so you can modify the source code
                         
						 Have any questions, contact developer email: eorsq@gmail.com
						 
						 Python compatibility > 2.7x > 3.x Version
"""
...
def start_process():
    ...
    while True:
        ...
        if firstrun and len(argv) == 2:
            ...
            input_hash = get_input("Encryption Hash : ")
